    ...
    return (
        ...
        <ProductContainer>
            ...
            <ReviewInputContainer>
                <ReviewTitleInput placeholder='리뷰 제목을 입력해주세요' onInput={checkTitleInput}/>
            ...
            <ReviewTagInputContainer>   
                <ReviewWriteInfo style={{fontWeight: '600'}}>제품과 어울리는 태그를 입력해주세요</ReviewWriteInfo>
                <ReviewWriteInfo style={{color: '#9f9f9f', fontSize: '12px'}}>이 제품의 태그로</ReviewWriteInfo>
                <ReviewWriteInfo style={{color: '#9f9f9f', fontSize: '12px'}}>#디자인 #애플 #스그 #실버 가 많아요</ReviewWriteInfo>
                <SearchBar>
                <SearchText />
                <SearchIconWrapper><SearchIcon src='/images/icon/search_icon.png' alt=''/></SearchIconWrapper>
                </SearchBar>
                <ReviewTagContainer>{reviewTagArr.map((tag, idx) => {return(<ReviewTagText>{tag}</ReviewTagText>)})}</ReviewTagContainer>
            </ReviewTagInputContainer>
        </ProductContainer>
        </>
    )
